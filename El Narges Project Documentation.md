...
- **زر التبديل السلس (Theme Toggle):** إضافة زر التبديل 🌓 في جميع اللوحات (Customer Portal و Admin Dashboard). يتم حفظ اختيار المستخدم في الـ `localStorage` للحفاظ على المظهر المفضل في الزيارات القادمة.

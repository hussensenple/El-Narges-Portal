...
### التحديثات الأخيرة (2026-08-16)
- تم إصلاح مشكلة ظهور موقع الشكاوى الداخلية (Internal Complaints) على الخريطة ثلاثية الأبعاد للمهندس، حيث تم الاعتماد على MongoDB لجلب معرف المبنى (BuildingID) في حالة عدم وجود الـ UUID في طبقات الخريطة.
- تم تعديل زر (Show All Issues) لإظهار النقاط الحمراء فوق كل المباني التي تحتوي على شكاوى نشطة بناءً على الاستعلام الصحيح.
- تم فصل الشكاوى النشطة (Active Tasks) بحيث لا تظهر في قائمة المهام الجديدة للمهندس بمجرد تعيين فني لها أو تغيير حالتها.

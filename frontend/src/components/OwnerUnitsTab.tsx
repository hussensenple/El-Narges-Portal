          ...
          {units.length > 0 && (
            <div style={{ borderTop: '1px solid #30363d', paddingTop: '16px', marginTop: '16px', flexShrink: 0, display: 'flex', justifyContent: 'flex-end' }}>
              <button 
                ...
                style={{ padding: '10px 20px', backgroundColor: '#da3633', color: '#fff', border: 'none', borderRadius: '6px', cursor: 'pointer', fontWeight: 'bold', fontSize: '14px', transition: 'background 0.2s', display: 'flex', alignItems: 'center', gap: '8px', pointerEvents: 'auto' }}
